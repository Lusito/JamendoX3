...
public class ReviewTrackQueryAdapter extends AbstractQueryAdapter<ReviewTrackQuery, ReviewTrack> {
    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd");

    private class ViewHolder extends AbstractViewHolder<ReviewTrack> {
        ...
        @Override
        public void onCreate(ReviewTrack entry) {
    ...
    public ReviewTrackQueryAdapter() {
        super(ReviewTrack.class);
    }
