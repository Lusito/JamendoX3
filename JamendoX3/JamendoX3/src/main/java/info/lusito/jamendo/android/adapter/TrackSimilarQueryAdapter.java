...
public class TrackSimilarQueryAdapter extends AbstractQueryAdapter<TrackSimilarQuery, TrackSimilar> {
    private boolean hideImage;
    private boolean hideArtist;
    private boolean hideAlbum;

    private class ViewHolder extends AbstractViewHolder<TrackSimilar> implements View.OnClickListener {
        ...
        @Override
        public void onCreate(TrackSimilar entry) {
        ...
        private String getArtistAlbum(TrackSimilar entry) {
            String value = "";
            if (!hideArtist) {
    ...
    public TrackSimilarQueryAdapter() {
        super(TrackSimilar.class);
    }

    /**
     * Call right after construction
     */
    public TrackSimilarQueryAdapter hideImage() {
        hideImage = true;
        return this;
    }
     ...
     * Call right after construction
     */
    public TrackSimilarQueryAdapter hideArtist() {
        hideArtist = true;
        return this;
    }
     ...
     * Call right after construction
     */
    public TrackSimilarQueryAdapter hideAlbum() {
        hideAlbum = true;
        return this;
    }
